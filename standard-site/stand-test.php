...
// Define the URL for the plugin list
define('PLUGIN_LIST_URL', 'https://raw.githubusercontent.com/yourusername/reponame/main/plugins.txt');

$site_theme = 'hello-elementor'; // Theme slug for Hello Elementor

// Function to fetch plugin slugs from an external source
...
function site_downloader_page() {
    ...
    // Fetch the plugin slugs from the external source
    $site_plugins = fetch_plugin_slugs();

    // Handle plugin activation, deactivation, and deletion
    ...
    echo '<h1>Dynamic Site Plugins & Theme with Elementor Templates</h1>';
    ...
    // Get installed plugins and filter for those in $site_plugins
    $all_plugins = get_plugins();
    echo '<h2>Selected Installed Plugins</h2>';
    echo '<table class="widefat fixed" cellspacing="0">';
    echo '<thead><tr><th>Plugin</th><th>Version</th><th>Status</th><th>Actions</th></tr></thead><tbody>';

    foreach ($all_plugins as $plugin_file => $plugin_data) {
        // Only show plugins that are in $site_plugins
