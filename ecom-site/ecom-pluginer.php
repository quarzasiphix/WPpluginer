...
define('PLUGIN_LIST_URL', 'https://raw.githubusercontent.com/quarzasiphix/WPpluginer/refs/heads/main/ecom-site/plugins.txt');
...
function site_downloader_page() {
    ...
    echo '<h2>Ecommerce plugins and setup</h2>';
